...
from cropforge.diffusion.tests.test_milestone14_leaf_inpainting import TestMilestone14LeafInpainting
from cropforge.diffusion.tests.test_milestone15_temporal_inpainting import TestMilestone15TemporalInpainting
from cropforge.diffusion.tests.test_milestone16_real_rgb_integrity import TestMilestone16RealRGBIntegrity
